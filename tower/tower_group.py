...
class TowerGroup:
    ...
    def add_tower(self, tower_name: str):
        ...
        if tower_name is None:
            return
        x, y = self.selected_plot.rect.center
        if tower_name == "alcohol":             # if menu you choose alcohol, then tower image will show alcohol image
            new_tower = Tower.Alcohol(x, y)
        elif tower_name == "rapid test":        # if menu you choose rapid, then tower image will show rapid image
            new_tower = Tower.RapidTest(x, y)
        elif tower_name == "pcr":               # if menu you choose pcr, then tower image will show pcr image
